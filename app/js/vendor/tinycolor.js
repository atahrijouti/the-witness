...
define(["require", "exports"], function (require, exports) {
    ...
    var Tinycolor = (function () {
        ...
        Tinycolor.prototype.toFilter = function (secondColor) {
        ...
        Tinycolor.prototype.toString = function (format) {
            if (format === void 0) { format = this._format; }
            ...
            return (formattedString === "" ? this.toHexString() : formattedString);
        };
        Tinycolor.prototype.clone = function () {
            return new Tinycolor(this.toString());
        };
        Tinycolor.prototype._applyModification = function (fn, args) {
        ...
        Tinycolor.prototype.brighten = function () {
            var args = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                args[_i - 0] = arguments[_i];
            }
        ...
        Tinycolor.prototype.desaturate = function () {
            var args = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                args[_i - 0] = arguments[_i];
            }
        ...
        Tinycolor.prototype.saturate = function () {
            var args = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                args[_i - 0] = arguments[_i];
            }
        ...
        Tinycolor.prototype._applyCombination = function (fn, args) {
            return fn.apply(null, [this].concat([].slice.call(args)));
        };
        Tinycolor.prototype.analogous = function () {
            var args = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                args[_i - 0] = arguments[_i];
            }
        ...
        Tinycolor.prototype.monochromatic = function () {
            var args = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                args[_i - 0] = arguments[_i];
            }
    ...
    function greyscale(color) {
        var new_color = new Tinycolor(color);
        return new_color.desaturate(100);
    }
    ...
    var hexNames = Tinycolor.hexNames = flip(Tinycolor.names);
    // Utilities
    // ---------
