...
export class Tinycolor {
    ...
    monochromatic(...args: any[]) {
        return this._applyCombination(monochromatic, arguments);
    }
    splitcomplement(...args: any[]) {
    ...
    // ---------------------
        ...
        static mix = function(color1, color2, amount) {
...
// Analyze the 2 colors and returns the color contrast defined by (WCAG Version 2)
        static readability = function(color1, color2) {
...
//    Tinycolor.isReadable("#000", "#111",{level:"AA",size:"large"}) => false
        static isReadable = function(color1, color2, wcag2) {
...
//    Tinycolor.mostReadable("#a8015a", ["#faf3f3"],{includeFallbackColors:true,level:"AAA",size:"small"}).toHexString(); // "#ffffff"
        static mostReadable = function(baseColor, colorList, args) {
        var bestColor = null;
        var bestScore = 0;
        var readability;
...
// String input requires "1.0" as input, so 1 will be treated as 1
        static fromRatio = function(color, opts = {}) {
...
// Can be called with any Tinycolor input
        static equals = function (color1, color2) {
...
function greyscale(color) {
    let new_color = new Tinycolor(color);
